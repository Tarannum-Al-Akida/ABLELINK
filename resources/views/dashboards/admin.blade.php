        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 sticky top-24">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.courses.index') }}" class="flex items-center w-full px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 font-medium transition-all">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <ul class="space-y-3">
                        <li class="flex justify-between text-slate-600 font-medium">Active Courses: <span class="font-bold text-slate-900">{{ $counts['courses'] ?? 0 }}</span></li>
